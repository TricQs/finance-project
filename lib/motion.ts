/**
 * lib/motion.ts
 * Preset animasi Framer Motion yang dipakai berulang di seluruh app
 * (terutama auth & dashboard), supaya easing & durasi konsisten
 * dan tidak ditulis ulang di setiap komponen.
 */
